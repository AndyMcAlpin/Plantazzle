...
PlantBasic.hasOne(MyPlant, { ...pPkFk, onDelete: 'CASCADE' })
PlantBasic.hasMany(PlantPicture, { ...pPkFk, onDelete: 'CASCADE' })
PlantBasic.hasMany(Comment, { ...pPkFk, onDelete: 'CASCADE' })
PlantBasic.hasOne(PlantGrowing, { ...pPkFk, onDelete: 'CASCADE' })
PlantBasic.hasOne(PlantCare, { ...pPkFk, onDelete: 'CASCADE' })
